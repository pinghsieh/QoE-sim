function createfigure_all_Un(X1, YMatrix1, policy, mode, filepath, identifier)
...
set(plot1(k),'DisplayName', strcat(policy, num2str(k)), 'Color', color_vec{k}, 'MarkerSize',10,'Marker','+');
end
% Create xlabel
xlabel({'Time (sec)'});
...
savefig(strcat(filepath, policy, '_', mode, '_', identifier, '.fig'));
